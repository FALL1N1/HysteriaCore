...
public:
    ...
    struct boss_hadronoxAI : public BossAI
    {
        ...
        {
            events.ScheduleEvent(EVENT_LEECH_POISON, urand(Seconds(5), Seconds(7)));
            events.ScheduleEvent(EVENT_ACID_CLOUD, urand(Seconds(7), Seconds(13)));
            events.ScheduleEvent(EVENT_WEB_GRAB, urand(Seconds(13), Seconds(19)));
            events.ScheduleEvent(EVENT_PIERCE_ARMOR, urand(Seconds(4), Seconds(7)));
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_LEECH_POISON:
                        ...
                        events.RepeatEvent(urand(Seconds(7), Seconds(9)));
                        break;
                    case EVENT_ACID_CLOUD:
                        if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM, 0, 100.0f))
                            DoCast(target, SPELL_ACID_CLOUD);
                        events.RepeatEvent(urand(Seconds(16), Seconds(23)));
                        break;
                    case EVENT_WEB_GRAB:
                        DoCastAOE(SPELL_WEB_GRAB);
                        events.RepeatEvent(urand(Seconds(20), Seconds(25)));
                        break;
                    case EVENT_PIERCE_ARMOR:
                        DoCastVictim(SPELL_PIERCE_ARMOR);
                        events.RepeatEvent(urand(Seconds(10), Seconds(15)));
                        break;
            ...
            void DoEvent(uint32 eventId) override
            {
                switch (eventId)
                {
                    case EVENT_SMASH:
                        ...
                        _events.RepeatEvent(urand(Seconds(13), Seconds(21)));
                        break;
                }
            }
...
class npc_anub_ar_crusher_champion : public CreatureScript
{
    public:
        ...
        struct npc_anub_ar_crusher_championAI : public npc_hadronox_crusherPackAI
        {
            ...
            void DoEvent(uint32 eventId)
            {
                switch (eventId)
                {
                    case EVENT_REND:
                        ...
                        _events.RepeatEvent(urand(Seconds(12), Seconds(16)));
                        break;
                    case EVENT_PUMMEL:
                        DoCastVictim(SPELL_PUMMEL);
                        _events.RepeatEvent(urand(Seconds(12), Seconds(17)));
                        break;
                }
            }
            ...
            void _EnterCombat()
            {
                _events.ScheduleEvent(EVENT_REND, urand(Seconds(4), Seconds(8)));
                _events.ScheduleEvent(EVENT_PUMMEL, urand(Seconds(15), Seconds(19)));
            }
        };
...
class npc_anub_ar_crusher_crypt_fiend : public CreatureScript
{
    public:
        ...
        struct npc_anub_ar_crusher_crypt_fiendAI : public npc_hadronox_crusherPackAI
        {
            ...
            void DoEvent(uint32 eventId)
            {
                switch (eventId)
                {
                    ...
                    case EVENT_INFECTED_WOUND:
                        ...
                        _events.RepeatEvent(urand(Seconds(16), Seconds(25)));
                        break;
                }
            }
            ...
            void _EnterCombat()
            {
                _events.ScheduleEvent(EVENT_CRUSHING_WEBS, urand(Seconds(4), Seconds(8)));
                _events.ScheduleEvent(EVENT_INFECTED_WOUND, urand(Seconds(15), Seconds(19)));
            }
        };
...
class npc_anub_ar_crusher_necromancer : public CreatureScript
{
    public:
        ...
        struct npc_anub_ar_crusher_necromancerAI : public npc_hadronox_crusherPackAI
        {
            ...
            void DoEvent(uint32 eventId)
            {
                switch (eventId)
                {
                    case EVENT_SHADOW_BOLT:
                        ...
                        _events.RepeatEvent(urand(Seconds(2), Seconds(5)));
                        break;
                    case EVENT_ANIMATE_BONES:
                        DoCastVictim(urand(0, 1) ? SPELL_ANIMATE_BONES_2 : SPELL_ANIMATE_BONES_1);
                        _events.RepeatEvent(urand(Seconds(35), Seconds(50)));
                        break;
                }
            }
            ...
            void _EnterCombat()
            {
                _events.ScheduleEvent(EVENT_SHADOW_BOLT, urand(Seconds(2), Seconds(4)));
                _events.ScheduleEvent(EVENT_ANIMATE_BONES, urand(Seconds(37), Seconds(45)));
            }
        };
        ...
        if (_nextMovement)
        {
            switch (_nextMovement)
            {
                ...
                case MOVE_HADRONOX_REAL:
                {
                    ...
                    Creature* hadronox = ObjectAccessor::GetCreature(*me, _instance->GetData64(DATA_HADRONOX));
    ...
    public:
        ...
        struct npc_anub_ar_championAI : public npc_hadronox_foeAI
        {
            ...
            void DoEvent(uint32 eventId)
            {
                switch (eventId)
                {
                    ...
                    case EVENT_TAUNT:
                        ...
                        _events.RepeatEvent(urand(Seconds(15), Seconds(50)));
                        break;
                }
            }
            ...
            void EnterCombat(Unit* /*who*/)
            {
                _events.ScheduleEvent(EVENT_REND, urand(Seconds(4), Seconds(8)));
                _events.ScheduleEvent(EVENT_PUMMEL, urand(Seconds(15), Seconds(19)));
                _events.ScheduleEvent(EVENT_TAUNT, urand(Seconds(15), Seconds(50)));
            }
        };
    ...
    public:
        ...
        void HandleApply(AuraEffect const* /*eff*/, AuraEffectHandleModes /*mode*/)
        {
            if (AuraEffect* effect = GetAura()->GetEffect(EFFECT_0))
                effect->SetPeriodicTimer(urand(2000, 17000));
        }
