        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = _events.ExecuteEvent())
            {
                ...
                case EVENT_UPDATE_INTRO_WORLDSTATE:
                {
                    ...
                    if (--EventRepeatCount)
                        _events.ScheduleEvent(EVENT_UPDATE_INTRO_WORLDSTATE, 60000);
                    else
                        _events.ScheduleEvent(EVENT_START_BATTLE, 60000);
                    break;
                }
                ...
                case EVENT_TALK_STEPS:
                {
                    ...
                    case 38:
                        ...
                        {
                            Position pos;
                            Varimathras->GetNearPosition(pos, 5.0f, static_cast<float>(M_PI));
                    ...
                    case 64:
                    {
                        ...
                        if (Creature* Sylvanas = ObjectAccessor::GetCreature(*me, zoneScript->GetData(NPC_SYLVANAS)))
                        {
