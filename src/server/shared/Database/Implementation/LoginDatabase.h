...
enum LoginDatabaseStatements
{
    ...
    */
	...
	//Account Control
	LOGIN_SEL_ACC_CONTR_ID,
	LOGIN_SEL_ACTIP,
	LOGIN_SEL_LASTIP,
	LOGIN_SEL_LASTIP2,
	LOGIN_INS_IPCHECK,
	LOGIN_UPD_IPCHECK,
	LOGIN_SEL_MULITPLEACC, 
	LOGIN_SEL_DOUPLE_IP_CHECK,
	LOGIN_SEL_CHECK_GM,
	LOGIN_REP_MULTIPLEACC,
	LOGIN_SEL_ACC_GRP_ID,
	LOGIN_SEL_ACCGRPNUM,
	LOGIN_SEL_ALL_WITH_ACCGRPID,
	LOGIN_SEL_NAME_BY_ID,

	//Starterpackage
	LOGIN_SEL_STARTERPACKAGE,
	LOGIN_INS_STARTERPACKAGE,
