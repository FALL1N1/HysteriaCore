...
m_respawnDelay(300), m_baseRespawnDelay(300), m_corpseDelay(60), m_baseCorpseDelay(60), m_respawnradius(0.0f), m_advanceMovementTime(3000), m_reactState(REACT_AGGRESSIVE),
...
{ 
    ...
    switch (m_deathState)
    {
        ...
        case ALIVE:
        {
            ...
            } else m_advanceMovementTime -= diff;
