...
int WorldSocket::HandleAuthSession(WorldPacket& recvPacket)
{
    ...
    QueryResult premresult = LoginDatabase.PQuery ("SELECT * FROM account_premium WHERE id = '%u'", id);
    ...
    ACE_NEW_RETURN (m_Session, WorldSession (id, this, AccountTypes(security), expansion, mutetime, locale, recruiter, isRecruiter, skipQueue, isPremium), -1);
